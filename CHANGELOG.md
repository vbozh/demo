...
> Source: YouTrack AIR project, fix version 262.132 (last synced 2026-07-12)
...
- Drag and Drop not supported ([AIR-5138](https://youtrack.jetbrains.com/issue/AIR-5138))
...
> **21 completed items** · 2 features · 2 improvements · 17 fixes
...
- Air icon alignment in main toolbar on Windows ([AIR-5608](https://youtrack.jetbrains.com/issue/AIR-5608))
- Duplicate progress spinner during Apply Locally on Windows ([AIR-5609](https://youtrack.jetbrains.com/issue/AIR-5609))
...
- Copy does not work on Windows ([AIR-5558](https://youtrack.jetbrains.com/issue/AIR-5558))
