...
> 59 completed items: 6 features, 8 improvements, 45 fixes
...
- View proposed diff directly in Editor tab ([AIR-5476](https://youtrack.jetbrains.com/issue/AIR-5476))
...
- Chat file mentions now show accurate change count ([AIR-6160](https://youtrack.jetbrains.com/issue/AIR-6160))
- Updated license texts on onboarding and login screens ([AIR-6217](https://youtrack.jetbrains.com/issue/AIR-6217))
- Improved MCP Tool Call Widgets rendering performance in WASM ([AIR-6332](https://youtrack.jetbrains.com/issue/AIR-6332))

### Fixes

#### Multi-Root Workspace

- Text search now scoped to current task only ([AIR-5716](https://youtrack.jetbrains.com/issue/AIR-5716))
- File mentions now provided by current task only ([AIR-5721](https://youtrack.jetbrains.com/issue/AIR-5721))
- Commands, skills and subagents now scoped to current task ([AIR-5723](https://youtrack.jetbrains.com/issue/AIR-5723))
...
- Repo selector in History tool now shows current task repos only ([AIR-5726](https://youtrack.jetbrains.com/issue/AIR-5726))
- Git-related actions (review changes, generate commit message, etc.) now scoped to current task's repository ([AIR-5727](https://youtrack.jetbrains.com/issue/AIR-5727))
...
- Agent requirements check now scoped to current task only ([AIR-5730](https://youtrack.jetbrains.com/issue/AIR-5730))
...
- AI Docs were saved to wrong project root when created ([AIR-5750](https://youtrack.jetbrains.com/issue/AIR-5750))
...
- Junie cloud task switched from Full Access to Ask mode unexpectedly ([AIR-6249](https://youtrack.jetbrains.com/issue/AIR-6249))
...
- Unavailable agents not filtered out in cloud task runs ([AIR-6210](https://youtrack.jetbrains.com/issue/AIR-6210))
- Custom agents not filtered out in docker task runs ([AIR-6211](https://youtrack.jetbrains.com/issue/AIR-6211))
- "Auto-open task changes" doesn't work for Codex ([AIR-6450](https://youtrack.jetbrains.com/issue/AIR-6450))

#### AI Model & Protocol Integration

- Claude Fable incorrectly showed 200K context window instead of 1M ([AIR-6065](https://youtrack.jetbrains.com/issue/AIR-6065))
- Claude not aware of skills in `.agents/skills` ([AIR-6141](https://youtrack.jetbrains.com/issue/AIR-6141))
...
- ACP tool call displayed raw tool ID instead of readable name ([AIR-5890](https://youtrack.jetbrains.com/issue/AIR-5890))
- OpenCode via acp.json does not answer ([AIR-6226](https://youtrack.jetbrains.com/issue/AIR-6226))
- Error while using Copilot via acp — hidden partition query failure ([AIR-6317](https://youtrack.jetbrains.com/issue/AIR-6317))
...
- Chat banners did not span full panel width ([AIR-5530](https://youtrack.jetbrains.com/issue/AIR-5530))
...
_Produced by Air Automation. Name: Generate Release Notes / Run: https://air.stgn.jetbrains.cloud/org/05cf1a7f-6ab5-713b-abd3-29d0c8a05e2d/automations/700dc751-f867-4758-aa14-92fd8704e23d?run=0f0d9064-0edf-499e-8ecc-a2404f3e36b3_
