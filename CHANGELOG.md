...
*45 completed items: 3 features, 6 improvements, 36 fixes. Sourced from YouTrack AIR project, fix version 262.132, as of 2026-07-20.*
...
- ACP tool call shows tool ID instead of tool name ([AIR-5890](https://youtrack.jetbrains.com/issue/AIR-5890)) ✨ resolved 2026-07-13
- Purple screen on Diff view ([AIR-6265](https://youtrack.jetbrains.com/issue/AIR-6265)) ✨ resolved 2026-07-13
- Pointer icon (mouse cursor) gets stuck in non-default state ([AIR-6291](https://youtrack.jetbrains.com/issue/AIR-6291)) ✨ resolved 2026-07-16
