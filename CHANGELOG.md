...
27 completed issues · 3 features · 4 improvements · 20 fixes
...
- **[Windows] Native-style buttons in update dialog** ([AIR-5755](https://youtrack.jetbrains.com/issue/AIR-5755)) *(new)*  
  Buttons in the "update available" dialog now use Windows native styling for better platform consistency.
...
- **CPU hog in idle** ([AIR-5812](https://youtrack.jetbrains.com/issue/AIR-5812))  
  Resolved a performance issue where Air consumed excessive CPU resources while idle.
...
*Produced by Air Automation. Name: Generate Release Notes / Run: https://air.stgn.jetbrains.cloud/org/05cf1a7f-6ab5-713b-abd3-29d0c8a05e2d/automations/700dc751-f867-4758-aa14-92fd8704e23d?run=91c3b7ef-fd2c-4379-8261-af1dd6969939*
