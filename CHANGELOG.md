...
- View proposed diff directly in the Editor tab ([AIR-5476](https://youtrack.jetbrains.com/issue/AIR-5476))
- AI Quota widget in the settings popup ([AIR-5846](https://youtrack.jetbrains.com/issue/AIR-5846))
...
- Improved MCP Tool Call Widget rendering performance in WASM ([AIR-6332](https://youtrack.jetbrains.com/issue/AIR-6332))
...
- ACP tool call panel was showing internal tool IDs instead of tool names ([AIR-5890](https://youtrack.jetbrains.com/issue/AIR-5890))
- Junie was ignoring the configured permission level ([AIR-5722](https://youtrack.jetbrains.com/issue/AIR-5722))
- Clear command not working ([AIR-5599](https://youtrack.jetbrains.com/issue/AIR-5599))
- Agents incompatible with Cloud task run were incorrectly shown ([AIR-6210](https://youtrack.jetbrains.com/issue/AIR-6210))
- Custom agents incompatible with Docker task run were incorrectly shown ([AIR-6211](https://youtrack.jetbrains.com/issue/AIR-6211))
- Claude compact summary and progress widget disappearing during task execution ([AIR-6289](https://youtrack.jetbrains.com/issue/AIR-6289))
- Error when using Copilot via acp.json (hidden partition query) ([AIR-6317](https://youtrack.jetbrains.com/issue/AIR-6317))
- Air was incorrectly using Credits instead of configured API tokens ([AIR-6367](https://youtrack.jetbrains.com/issue/AIR-6367))
- Fast mode toggle not shown for OpenAI o5.6 models ([AIR-6389](https://youtrack.jetbrains.com/issue/AIR-6389))
