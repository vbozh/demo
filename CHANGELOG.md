...
- **Empty drafts are automatically removed** ([AIR-4083](https://youtrack.jetbrains.com/issue/AIR-4083))  
  Draft messages that are left empty are now cleaned up automatically, reducing clutter in the drafts list.
...
- **Excessive warnings for unknown permission modes** ([AIR-5661](https://youtrack.jetbrains.com/issue/AIR-5661))  
  Suppressed noisy warning messages that were incorrectly triggered by unrecognized permission mode values.
...
- **Tooltip flicker on hover** ([AIR-5008](https://youtrack.jetbrains.com/issue/AIR-5008))  
  Eliminated the flickering behavior that occurred when hovering over elements with tooltips.

---

*Produced by Air Automation. Name: Generate Release Notes / Run: https://air.stgn.jetbrains.cloud/org/05cf1a7f-6ab5-713b-abd3-29d0c8a05e2d/automations/700dc751-f867-4758-aa14-92fd8704e23d?run=c4866264-cb15-490b-af81-e1f7abeecc97*
