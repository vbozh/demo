...
- Pointer icon (mouse cursor) gets stuck in non-default state ([AIR-6291](https://youtrack.jetbrains.com/issue/AIR-6291))
- Air using Credits over API tokens when API tokens should be used ([AIR-6367](https://youtrack.jetbrains.com/issue/AIR-6367))
