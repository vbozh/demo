...
- Support commands for agents added via acp.json ([AIR-5753](https://youtrack.jetbrains.com/issue/AIR-5753)) ✨
...
- Cache available commands for custom ACP agents ([AIR-5903](https://youtrack.jetbrains.com/issue/AIR-5903)) ✨
...
- Failed to execute diff on task switching ([AIR-5992](https://youtrack.jetbrains.com/issue/AIR-5992)) ✨
- Port forwarding from Docker agent doesn't work ([AIR-3512](https://youtrack.jetbrains.com/issue/AIR-3512)) ✨
