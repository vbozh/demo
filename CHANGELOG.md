...
- Implement AI Quota widget in settings popup ([AIR-5846](https://youtrack.jetbrains.com/issue/AIR-5846))
- Add ability to see proposed diff in the Editor tab ([AIR-5476](https://youtrack.jetbrains.com/issue/AIR-5476))
- Add Open in Web context actions for Cloud tasks ([AIR-6080](https://youtrack.jetbrains.com/issue/AIR-6080))
- Update license texts on onboarding/login screens ([AIR-6217](https://youtrack.jetbrains.com/issue/AIR-6217))
- Make Git-related features aware of focused workspace root ([AIR-5502](https://youtrack.jetbrains.com/issue/AIR-5502))
