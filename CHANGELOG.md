...
- Proposed diff preview available in the Editor tab ([AIR-5476](https://youtrack.jetbrains.com/issue/AIR-5476))
...
- Support for Gemini 3.6 Flash models added ([AIR-6444](https://youtrack.jetbrains.com/issue/AIR-6444))
...
- Claude compact summary & progress widget dropped during task flow ([AIR-6289](https://youtrack.jetbrains.com/issue/AIR-6289))
- ACP tool call shows tool ID instead of tool name ([AIR-5890](https://youtrack.jetbrains.com/issue/AIR-5890))
- Agents were not filtered correctly for cloud task runs ([AIR-6210](https://youtrack.jetbrains.com/issue/AIR-6210))
...
- Error while using Copilot via ACP (hidden partition query) ([AIR-6317](https://youtrack.jetbrains.com/issue/AIR-6317))
...
- Docker agent task hangs indefinitely when copying resources to agent volume ([AIR-6440](https://youtrack.jetbrains.com/issue/AIR-6440))
- "Auto-open task changes" doesn't work for Codex ([AIR-6450](https://youtrack.jetbrains.com/issue/AIR-6450))
- Custom agents were not filtered out of docker task runs ([AIR-6211](https://youtrack.jetbrains.com/issue/AIR-6211))
